...
# \ line continuation
productDf.join(brandDf, productDf["brand_id"] ==  brandDf["brand_id"], "rightouter")\
         .select("product_id", "product_name",   productDf["brand_id"], "brand_name")\
         .show()
...
# cross join
# cross all products with all brands
